...
(function() {
  ...
  Tron = (function() {
    ...
    Tron.prototype.test = function() {
      var args, check, checks, color, empty_trys, error, found, input, k, key, m, missed_checks, try_test, v, value, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      switch (typeof input) {
        ...
        case 'string':
          ...
          if ((_ref1 = this.coverage_map) != null) {
            if ((_ref2 = _ref1['current']) == null) {
              _ref1['current'] = [];
            }
          }
          if ((_ref3 = this.coverage_map) != null) {
            _ref3['current'].push(input);
          }
          try {
            color = this.color('green');
            (_ref4 = this.named_tests)[input].apply(_ref4, args);
            check = '✓';
    ...
    Tron.prototype.sync = function(tron_object) {
      ...
      */
      ...
      var item, k, shared_props, v, _base, _i, _len, _ref, _ref1, _results;
      ...
      for (k in _ref) {
        v = _ref[k];
        if ((_ref1 = (_base = this['coverage_map'])[k]) == null) {
          _base[k] = [];
        }
